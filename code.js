function calculatorAge(){
    ...
    const birthMonth=birthDatePart[1];
    ...
    result.innerHTML=`
    <div class="result-items"><h3>Age:</h3><p>${ageInYears} Years ${ageInMonths % 12} Months ${ageInDays % 30} Days</p></div>
